...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Delightful localization of .storyboard and .xib files.}
  spec.description   = %q{Delightful localization of .storyboard and .xib files. Fame makes it easy to enable specific Interface Builder elements to be translated and exported to a .strings file.}
